                ...
                {appState === 'idle' && (
                     <div className="relative flex flex-col items-center justify-center w-full">
                        ...
                        {GHOST_POLAROIDS_CONFIG.map((config, index) => (
                             <motion.div
                                key={index}
                                className="absolute w-80 h-[26rem] rounded-lg p-4 bg-white/60 border border-gray-200 shadow-sm"
                        ...
                        >
                            ...
                            <p className="mt-8 text-neutral-500 text-center max-w-xs text-base">
                                Upload a photo to start your journey through the decades!
                            </p>
                        </motion.div>
                    </div>
                )}
